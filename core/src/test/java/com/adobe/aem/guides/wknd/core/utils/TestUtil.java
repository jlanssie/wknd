...
public class TestUtil {
    ...
    private static final String MOCK_JCR_PAGE_PATH = "/content/project/country/language/page/jcr:content/root/container/container/%s";

    public static String getMockJcrPath(String componentName) {
        return String.format(MOCK_JCR_PAGE_PATH, componentName);
    }
