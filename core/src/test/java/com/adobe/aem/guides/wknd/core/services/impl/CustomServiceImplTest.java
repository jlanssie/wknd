...
class CustomServiceImplTest {
    ...
    void enabled() {
        ...
        assertEquals(StringUtils.EMPTY, customService.getAnotherCustomString());
    ...
    void disabled() {
        ...
        lenient().when(customServiceConf.customString()).thenReturn(StringUtils.EMPTY);

        assertEquals(StringUtils.EMPTY, customService.getCustomString());
        assertEquals(StringUtils.EMPTY, customService.getAnotherCustomString());
